...
extern PyObject * sumdR2_C(PyObject *self, PyObject *args);
...
static PyMethodDef base_functions[] = {
    ...
    {"sumdR2_C", (PyCFunction)sumdR2_C, METH_VARARGS, "sumdR2 C implementation"},
    {NULL}		/* sentinel */
};
...
PyMODINIT_FUNC initsumdR2(void)
...
#endif
{
  ...
  if (base_mod == NULL)
#else
  if (!(base_mod = Py_InitModule3("sumdR2", base_functions, base__doc__)))
#endif
    INITERROR;
